...
#define LR PORTDbits.RD14
#define LMR PORTDbits.RD15
#define LM PORTFbits.RF2
#define LML PORTFbits.RF8
#define LL PORTDbits.RD13
...
int main() {
    ...
    while (1) {
        ...
        if (mode == 1) {
            ...
            if (ADC > 500 || (Btn1 == 1 && buttonLock1 == 0)) {
